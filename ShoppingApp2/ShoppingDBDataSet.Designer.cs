...
namespace ShoppingApp2 {
    ...
    public partial class ShoppingDBDataSet : global::System.Data.DataSet {
        ...
        public partial class TBL_PRODUCTDataTable : global::System.Data.TypedTableBase<TBL_PRODUCTRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TBL_PRODUCTRow AddTBL_PRODUCTRow(string PRODUCT_NAME, int PRODUCT_PRICE, string PRODUCT_CATEGORY, int PRODUCT_QUANTITY) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TBL_PRODUCTRow FindByPRODUCT_CODE(int PRODUCT_CODE) {
            ...
            private void InitClass() {
                ...
                this.columnPRODUCT_CATEGORY.MaxLength = 2147483647;
        ...
        public partial class TBL_PRODUCTRow : global::System.Data.DataRow {
            ...
            public int PRODUCT_CODE {
                get {
                    return ((int)(this[this.tableTBL_PRODUCT.PRODUCT_CODEColumn]));
                }
                set {
                    this[this.tableTBL_PRODUCT.PRODUCT_CODEColumn] = value;
                }
            }
            ...
            public string PRODUCT_CATEGORY {
                get {
                    return ((string)(this[this.tableTBL_PRODUCT.PRODUCT_CATEGORYColumn]));
                }
                set {
...
namespace ShoppingApp2.ShoppingDBDataSetTableAdapters {
    ...
    public partial class TBL_PRODUCTTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[TBL_PRODUCT] WHERE (([PRODUCT_CODE] = @Original_PRODUCT_CODE) " +
                "AND ([PRODUCT_PRICE] = @Original_PRODUCT_PRICE) AND ([PRODUCT_QUANTITY] = @Origi" +
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[TBL_PRODUCT] ([PRODUCT_NAME], [PRODUCT_PRICE], [PRODUCT_CATEGORY], [PRODUCT_QUANTITY]) VALUES (@PRODUCT_NAME, @PRODUCT_PRICE, @PRODUCT_CATEGORY, @PRODUCT_QUANTITY);
SELECT PRODUCT_CODE, PRODUCT_NAME, PRODUCT_PRICE, PRODUCT_CATEGORY, PRODUCT_QUANTITY FROM TBL_PRODUCT WHERE (PRODUCT_CODE = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[TBL_PRODUCT] SET [PRODUCT_NAME] = @PRODUCT_NAME, [PRODUCT_PRICE] = @PRODUCT_PRICE, [PRODUCT_CATEGORY] = @PRODUCT_CATEGORY, [PRODUCT_QUANTITY] = @PRODUCT_QUANTITY WHERE (([PRODUCT_CODE] = @Original_PRODUCT_CODE) AND ([PRODUCT_PRICE] = @Original_PRODUCT_PRICE) AND ([PRODUCT_QUANTITY] = @Original_PRODUCT_QUANTITY));
SELECT PRODUCT_CODE, PRODUCT_NAME, PRODUCT_PRICE, PRODUCT_CATEGORY, PRODUCT_QUANTITY FROM TBL_PRODUCT WHERE (PRODUCT_CODE = @PRODUCT_CODE)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT PRODUCT_CODE, PRODUCT_NAME, PRODUCT_PRICE, PRODUCT_CATEGORY, PRODUCT_QUANT" +
                "ITY FROM dbo.TBL_PRODUCT";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT PRODUCT_CODE, PRODUCT_NAME, PRODUCT_PRICE, PRODUCT_CATEGORY, PRODUCT_QUANT" +
                "ITY FROM dbo.TBL_PRODUCT";
        ...
        public virtual int Fill(ShoppingDBDataSet.TBL_PRODUCTDataTable dataTable) {
        ...
        public virtual ShoppingDBDataSet.TBL_PRODUCTDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ShoppingDBDataSet.TBL_PRODUCTDataTable dataTable = new ShoppingDBDataSet.TBL_PRODUCTDataTable();
        ...
        public virtual int FillBy(ShoppingDBDataSet.TBL_PRODUCTDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ShoppingDBDataSet.TBL_PRODUCTDataTable dataTable) {
        ...
        public virtual int Delete(int Original_PRODUCT_CODE, int Original_PRODUCT_PRICE, int Original_PRODUCT_QUANTITY) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_PRODUCT_CODE));
            this.Adapter.DeleteCommand.Parameters[1].Value = ((int)(Original_PRODUCT_PRICE));
        ...
        public virtual int Insert(string PRODUCT_NAME, int PRODUCT_PRICE, string PRODUCT_CATEGORY, int PRODUCT_QUANTITY) {
        ...
        public virtual int Update(string PRODUCT_NAME, int PRODUCT_PRICE, string PRODUCT_CATEGORY, int PRODUCT_QUANTITY, int Original_PRODUCT_CODE, int Original_PRODUCT_PRICE, int Original_PRODUCT_QUANTITY, int PRODUCT_CODE) {
            if ((PRODUCT_NAME == null)) {
                throw new global::System.ArgumentNullException("PRODUCT_NAME");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(PRODUCT_CODE));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string PRODUCT_NAME, int PRODUCT_PRICE, string PRODUCT_CATEGORY, int PRODUCT_QUANTITY, int Original_PRODUCT_CODE, int Original_PRODUCT_PRICE, int Original_PRODUCT_QUANTITY) {
            return this.Update(PRODUCT_NAME, PRODUCT_PRICE, PRODUCT_CATEGORY, PRODUCT_QUANTITY, Original_PRODUCT_CODE, Original_PRODUCT_PRICE, Original_PRODUCT_QUANTITY, Original_PRODUCT_CODE);
        }
    }
